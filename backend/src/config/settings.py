...
AI_MODEL = os.getenv("AI_MODEL", "mistralai/mistral-large-2512")
AI_TIMEOUT_SECONDS = int(os.getenv("AI_TIMEOUT_SECONDS", "60"))
AI_MAX_TOKENS = int(os.getenv("AI_MAX_TOKENS", "4096"))
AI_TEMPERATURE = float(os.getenv("AI_TEMPERATURE", "0.1"))
AI_MAX_PROMPT_CHARS = int(os.getenv("AI_MAX_PROMPT_CHARS", "4000"))
AI_MAX_CONTEXT_ITEMS = int(os.getenv("AI_MAX_CONTEXT_ITEMS", "1000"))
AI_MAX_OPERATIONS = int(os.getenv("AI_MAX_OPERATIONS", "200"))
AI_TRANSCRIPTION_BACKEND = os.getenv("AI_TRANSCRIPTION_BACKEND", "local")
AI_TRANSCRIPTION_BASE_URL = os.getenv("AI_TRANSCRIPTION_BASE_URL", "")
AI_TRANSCRIPTION_API_KEY = os.getenv("AI_TRANSCRIPTION_API_KEY", "")
AI_TRANSCRIPTION_MODEL = os.getenv("AI_TRANSCRIPTION_MODEL", "whisper-large-v3-turbo")
AI_TRANSCRIPTION_TIMEOUT_SECONDS = int(os.getenv("AI_TRANSCRIPTION_TIMEOUT_SECONDS", "60"))
AI_TRANSCRIPTION_MAX_BYTES = int(os.getenv("AI_TRANSCRIPTION_MAX_BYTES", str(10 * 1024 * 1024)))
AI_TRANSCRIPTION_LOCAL_MODEL = os.getenv("AI_TRANSCRIPTION_LOCAL_MODEL", "base")
AI_TRANSCRIPTION_LOCAL_DEVICE = os.getenv("AI_TRANSCRIPTION_LOCAL_DEVICE", "cpu")
AI_TRANSCRIPTION_LOCAL_COMPUTE_TYPE = os.getenv("AI_TRANSCRIPTION_LOCAL_COMPUTE_TYPE", "int8")
AI_TRANSCRIPTION_LOCAL_CACHE_DIR = os.getenv("AI_TRANSCRIPTION_LOCAL_CACHE_DIR", str(ROOT_DIR / ".whisper-models"))
AI_TRANSCRIPTION_LOCAL_CPU_THREADS = int(os.getenv("AI_TRANSCRIPTION_LOCAL_CPU_THREADS", "4"))
AI_TRANSCRIPTION_PRELOAD = os.getenv("AI_TRANSCRIPTION_PRELOAD", "True").lower() == "true"
