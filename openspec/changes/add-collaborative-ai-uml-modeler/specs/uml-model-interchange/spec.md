...
#### Scenario: Perfil Enterprise Architect todavía no validado
- **WHEN** no existen fixtures reales de ida y vuelta aprobados con Enterprise Architect 17.2
- **THEN** el perfil Sparx permanece oculto y la interfaz no anuncia compatibilidad no comprobada
...
### Requirement: Importación simple y atómica desde inicio
El sistema SHALL validar un archivo antes de crear su proyecto y SHALL aplicar la creación y la importación dentro de una única transacción.

#### Scenario: Archivo inválido desde inicio
- **WHEN** el usuario intenta importar XML/XMI inválido desde la lista de proyectos
- **THEN** el sistema muestra el error y no deja un proyecto vacío
